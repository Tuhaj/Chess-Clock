  ...
  function displayTime(time, short) {
    ...
    // these two options are different in one point, change!
  };

  function updateView() {
    document.getElementById('counter1').innerHTML = displayTime(timers[0]);  
    document.getElementById('counter2').innerHTML = displayTime(timers[1]);
    document.getElementById('intertimer1').innerHTML = displayTime(intertimers[0], true);  
    document.getElementById('intertimer2').innerHTML = displayTime(intertimers[1], true);
    blur();
  };
  ...
  // var click = document.getElementById("click");
  // click.addEventListener ("loadeddata", function() {
  //   alert('dziala');
  // });  
